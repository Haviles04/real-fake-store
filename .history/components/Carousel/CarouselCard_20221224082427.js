...
function CarouselCard({ item, pcRef, currentX,setMaxBackward,setMaxBackward }) {
  ...
  const handleTouch = (e) => {
   ...
   currentX.currentX = e.currentTarget.offsetLeft;
    if (onMobile) {
  ...
  return (
    <div
      ...
      key={item.id}
      onTouchEnd={(e) => {e.stopPropagation(); handleTouch(e)}}
    >
