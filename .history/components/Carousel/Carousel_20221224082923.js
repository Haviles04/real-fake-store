  ...
  return (
    <div className={styles.main}>
      ...
      <div ref={caro} className={styles.mainCaro}>
        {products.map((item) => (
          <CarouselCard pcRef={pcRef} key={item.id} caro={caro} products={products} currentX={currentX} setMaxBackward={setMaxBackwards} setMaxForward={setMaxForward} item={item} />
        ))}
      </div>
      <button
